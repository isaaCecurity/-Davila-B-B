...
| P9.7 | Cash session & payments | P5.4, P5.6 | queued | **ONLINE IN PROGRESS 2026-08-26.** Cash-session listing/open/close plus till-scoped payment entry are implemented in `apps/mobile/app/finance/` and `packages/api`/`packages/hooks`. Expense capture and offline queuing remain outstanding. |
