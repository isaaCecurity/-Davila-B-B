...
| P9.3 | Ticket creation (driver) | P4.4 | queued, immutable | BLOCKED (006, 019, 020). Correction: the "005" reference here was stale — BLOCKER-005 was RESOLVED 2026-08-14; the live blocker was always 006. Scope widened 2026-08-24 by ADR-001 (Approved) — driver-created tickets are now a trip-scoped workflow, not a standalone P9.3 slice; see `docs/ADR-001-Driver-Workflow-Redesign-MVP.md`. |
