...
--   invite_by_role_email_or_phone (AD-026) added functions complete_counter_sale and
--   private.manages_branch, a phone column + 2 CHECKs + 1 index on organization_invites, and
