...
--   NOTE 2026-09-14: counts above are as of the last full regeneration. Since then
--   migrations counter_sale_shortcut (AD-024), bind_invite_acceptance_to_email (AD-025) and
...
--   verbatim in the APPENDED MIGRATIONS section at the end of this file. The object counts here
--   have NOT been re-verified live since those changes.
--   Triggers                            : 58
...
-- ============================================================
-- SECTION: APPENDED MIGRATIONS (applied live after the last full regeneration)
-- ============================================================

-- ── 20260913120000_counter_sale_shortcut.sql (AD-024, applied live 2026-09-14) ──
...
-- ── 20260913120100_bind_invite_acceptance_to_email.sql (AD-025, applied live 2026-09-14) ──
...
-- ── 20260914100000_invite_by_role_email_or_phone.sql (AD-026, applied live 2026-09-14) ──
...
-- ── 20260914130000_revenue_report_and_product_performance.sql (P9.9 Q1/Q2, applied live 2026-09-14) ──
...
-- ── 20260917090000_search_invite_actions_profile_update.sql (P9.9 Q6-Q8, applied live 2026-09-17) ──
...
-- ── 20260917190000_storage_replace_delete_rules.sql (TD-021 / AD-028, applied live 2026-09-17) ──
...
-- ── 20260919120000_smoke_role_credentials.sql (smoke-test fixtures, applied live 2026-09-19) ──
...
-- ── 20260920100000_remove_accountant_role.sql (AD-029: accountant role removed, applied live 2026-09-20) ──
