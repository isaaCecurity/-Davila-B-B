...
--   migration counter_sale_shortcut (AD-024) added 1 public function
--   (complete_counter_sale) and replaced guard_ticket_status_transition(); both are
--   carried verbatim in the APPENDED MIGRATIONS section at the end of this file. The
--   function count here has NOT been re-verified live since that change.
--   Triggers                            : 58
